...
export class CitizenFrActivityInfoComponent implements OnInit, OnDestroy {
    ...
    actinityInformationDialog = this.fb.group<ActivityInfoForm>({
        ...
        startDate: this.fb.control<any | null>(null, { validators: Validators.required }),
        endDate: this.fb.control<any | null>(null),
    });
    placeForm = this.fb.group({
        placeType: this.fb.control<string | null>(null, { validators: Validators.required }),
        tenureType: this.fb.control<string | null>(null),
        area: this.fb.control<string | null>(null),        // اگر عدد: Validators.pattern(/^\d+$/)
        hasKeyMoney: this.fb.control<boolean | null>(null, { validators: Validators.required }),
    });
