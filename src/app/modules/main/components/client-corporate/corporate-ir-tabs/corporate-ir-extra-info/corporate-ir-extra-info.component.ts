...
@Component({
    ...
    templateUrl: './corporate-ir-extra-info.component.html',
    styleUrl: './corporate-ir-extra-info.component.scss',
})
export class CorporateIrExtraInfoComponent implements OnInit {
