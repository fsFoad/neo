...
import { FormArray, FormGroup, FormsModule, NonNullableFormBuilder, ReactiveFormsModule, Validators,
} from '@angular/forms';
...
@Component({
    ...
    templateUrl: './corporate-ir-commercial-info.component.html',
    styleUrl: './corporate-ir-commercial-info.component.scss',
})
export class CorporateIrCommercialInfoComponent {
