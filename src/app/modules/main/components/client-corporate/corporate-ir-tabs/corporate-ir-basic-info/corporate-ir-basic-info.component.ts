...
@Component({
    selector: 'app-corporate-ir-basic-info',
    imports: [
        ButtonDirective,
        Checkbox,
        DropdownModule,
    ...
    templateUrl: './corporate-ir-basic-info.component.html',
    styleUrl: './corporate-ir-basic-info.component.scss',
})
export class CorporateIrBasicInfoComponent implements OnInit {
