...
@Component({
    ...
    templateUrl: './corporate-ir-relations-info.component.html',
    styleUrl: './corporate-ir-relations-info.component.scss',
})
export class CorporateIrRelationsInfoComponent implements OnInit {
