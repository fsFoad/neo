...
@Component({
    ...
    templateUrl: './corporate-contact-info.component.html',
    styleUrl: './corporate-contact-info.component.scss',
})
export class CorporateContactInfoComponent implements OnInit {
